<template>
  <footer class="bg-dark-lighter border-t border-gray-800 py-12">
    <div class="section-container">
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        ...
        <div class="md:col-span-2">
          ...
          <p class="text-gray-400 mb-4 max-w-md">
            O melhor serviço de IPTV do Brasil. Mais de 1500 canais com qualidade HD/4K 
            e suporte 24/7 para toda a família.
          </p>
          <div class="flex gap-4">
            ...
            <a href="https://wa.me/5511999999999" target="_blank" rel="noopener" class="social-link">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="border-t border-gray-800 pt-8 text-center">
        ...
        <p class="text-gray-500 text-xs mt-2">
          Este site é apenas um exemplo demonstrativo.
        </p>
      </div>
    </div>
  </footer>
